...
import AddTopic from './user/AddTopic'
import Topics from './user/CourseTopic'
import EditTopic from './user/EditTopic'
import TopicDetail from './user/TopicDetail'
import EditCourse from './user/EditModule'
